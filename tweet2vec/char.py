...
from settings_char import NUM_EPOCHS, N_BATCH, MAX_LENGTH, SCALE, WDIM, MAX_CLASSES, LEARNING_RATE, DISPF, SAVEF, \
    REGULARIZATION, RELOAD_MODEL, MOMENTUM, SCHEDULE
...
if __name__ == '__main__':
    ...
    valdata="../data/test.txt"

    modelpath="best_model"
    # main(sys.argv[1], sys.argv[2], sys.argv[3])
    main(traindata, valdata, modelpath)
